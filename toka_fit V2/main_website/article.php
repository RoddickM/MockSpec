    ...
    <body>
        <?php include('includes/navbar.html') ?>
            ...
            <div class="projcard-container">
                        ...
                        <div class="projcard-innerbox">
                            ...
                            <div class="projcard-textbox">
                                ...
                                <div class="projcard-description">When it comes to physique improvements, muscle building is often a top priority.
                                                                    Added muscle mass will increase the definition of your muscles, improve your lean body mass, 
                                                                    and add bulk and size to your frame in all the right places.
                                                                    Muscle growth takes time, persistence, and a long-term...
                                                                    </div>
                                <div class="projcard-tagbox">
                                    <span class="projcard-tag">Fitness</span>
                                    <span class="projcard-tag">Muscles</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <a href="article-cook_healthy.php">
                    <div class="projcard projcard-green">
                        <div class="projcard-innerbox">
                            <img class="projcard-img" src="includes/images/article_healthy_eating.jpg" />
                            <div class="projcard-textbox">
                ...
                <a href="article-jogging.php">
                    <div class="projcard projcard-green">
                        <div class="projcard-innerbox">
                            <img class="projcard-img" src="includes/images/article_jogging.jpg" />
                            <div class="projcard-textbox">
